...
def main():
    ...
    # Generate dataset
    dataset = create_dataset(n_samples=30, n_features=4,
    ...
    estimator,elap_time = k_means_clustering(data=scaleddata,plot=0,p_init='k-means++',p_n_clusters=5,p_n_init=10,p_n_jobs=4)
    ...
    # Discover groups
    CART_classifier(dataset,estimator)
