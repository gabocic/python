...
parser.add_argument('-s','--samples', type=int, nargs='+',required=True,
                           help='Centers')
...
data,tags = datasets.make_blobs(n_samples=args.samples[0], n_features=args.attributes[0], centers=args.centers[0], cluster_std=1.0, center_box=(-10.0, 10.0), shuffle=True, random_state=None)
